...
namespace Microsoft.Agents.Extensions.Teams.Tests.Model
{
    ...
    public class MessageActionsPayloadTests
    {
        ...
        public void TestSerializationDeserialization()
        {
            ...
            var serializedPayload = ProtocolJsonSerializer.ToJson(payload);
            var deserializedPayload = ProtocolJsonSerializer.ToObject<MessageActionsPayload>(serializedPayload);
