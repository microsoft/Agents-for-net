    ...
    public class TeamsRouteBuilderTests
    {
        ...
        public void TeamsFeedbackRouteBuilder_Build_SetsTeamsChannelAndInvokeFlag()
        {
            var route = TeamsFeedbackRouteBuilder.Create()
                .WithChannelId(Channels.Outlook)
        ...
        public async Task TeamsMessageRouteBuilder_WithText_String_UsesTeamsTurnContext_AndMatchesTeamsOnly()
        {
            ...
            var teamsMatch = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "hello");
            var teamsMiss = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "goodbye");
            var outlookMatch = CreateActivity(ActivityTypes.Message, Channels.Outlook, text: "hello");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "goodbye");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var teamsMatch = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "status 200");
            var teamsMiss = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "hello");
            var outlookMatch = CreateActivity(ActivityTypes.Message, Channels.Outlook, text: "status 200");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "hello");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var teamsMatch = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "ping");
            var teamsMiss = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "ignored");
            var outlookMatch = CreateActivity(ActivityTypes.Event, Channels.Outlook, name: "ping");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "ignored");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var teamsMatch = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "status:ok");
            var teamsMiss = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "ping");
            var outlookMatch = CreateActivity(ActivityTypes.Event, Channels.Outlook, name: "status:ok");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "ping");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var teamsMatch = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Msteams);
            teamsMatch.MembersAdded = new List<ChannelAccount> { new ChannelAccount { Id = "user1" } };
            var teamsMiss = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Msteams);
            teamsMiss.MembersRemoved = new List<ChannelAccount> { new ChannelAccount { Id = "user2" } };
            var outlookMatch = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Outlook);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Msteams);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var teamsMatch = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Msteams, text: "selector");
            var teamsMiss = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Msteams, text: "ignored");
            var outlookMatch = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Outlook, text: "selector");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Msteams, text: "ignored");
        ...
        public async Task TeamsTypeRouteBuilder_WithType_String_UsesTeamsTurnContext_AndMatchesTeamsOnly()
        {
            var adapter = new NotImplementedAdapter();
            var teamsMatch = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "hello");
            var teamsMiss = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "hello");
            var outlookMatch = CreateActivity(ActivityTypes.Message, Channels.Outlook, text: "hello");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "hello");
        ...
        {
            var adapter = new NotImplementedAdapter();
            var teamsMatch = CreateActivity("invoke/custom", Channels.Msteams);
            var teamsMiss = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "hello");
            var outlookMatch = CreateActivity("invoke/custom", Channels.Outlook);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.MessageUpdate, Channels.Msteams);
            nonMatchingActivity.ChannelData = new Microsoft.Teams.Api.ChannelData
            {
        ...
        {
            var adapter = new NotImplementedAdapter();
            var nonMatchingActivity = CreateActivity(ActivityTypes.MessageDelete, Channels.Msteams);
            nonMatchingActivity.ChannelData = new Microsoft.Teams.Api.ChannelData
            {
                EventType = "unknown"
            };
