...
namespace Microsoft.Agents.Extensions.Teams.Tests.App
{
    public class AgentApplicationAttributesTests
    {
        ...
        public async Task TeamsActivityRouteAttribute_ExactType()
        {
            ...
            var activity = CreateActivity(ActivityTypes.Event, Channels.Msteams);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity(ActivityTypes.Invoke, Channels.Msteams);
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity("customActivityType", Channels.Msteams);
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity(ActivityTypes.InstallationUpdate, Channels.Msteams);
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "hi");
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity(ActivityTypes.Event, Channels.Msteams, name: "mySpecialEvent");
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity(ActivityTypes.ConversationUpdate, Channels.Msteams);
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        public async Task TeamsHandoffRouteAttribute_FiresOnHandoff_AndSendsInvokeResponse()
        {
            ...
            var activity = CreateActivity(ActivityTypes.Invoke, Channels.Msteams, name: "handoff/action", value: new { Continuation = "continue-token" });
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity(ActivityTypes.EndOfConversation, Channels.Msteams);
            var turnContext = CreateTurnContext(adapter, activity);
        ...
        {
            var adapter = new NotImplementedAdapter();
            var activity = CreateActivity(ActivityTypes.Message, Channels.Msteams, text: "hello");
            var turnContext = CreateTurnContext(adapter, activity);
    ...
    class TeamsActivityRouteTypeApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnEvent(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
            Calls.Add("OnEvent");
    ...
    class TeamsActivityRouteRegexApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnEventOrInvoke(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
    ...
    class TeamsActivityRouteAnyApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        [TeamsActivityRoute]
        public Task OnAny(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
            Calls.Add("OnAny");
            return Task.CompletedTask;
        }
    ...
    class TeamsInstallationUpdateRouteApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnInstallationUpdate(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
    ...
    class TeamsMessageRouteTextApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnHi(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
            Calls.Add("OnHi");
            return Task.CompletedTask;
        }
    ...
    class TeamsEventRouteRegexApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnMyRegexEvent(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
    ...
    class TeamsConversationUpdateRouteApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnAnyConversationUpdate(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
    ...
    class TeamsMembersAddedRouteApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnMembersAdded(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
    ...
    class TeamsMembersRemovedRouteApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnMembersRemoved(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
    ...
    class TeamsHandoffRouteApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        [TeamsHandoffRoute]
        public Task OnHandoff(TeamsTurnContext ctx, ITurnState state, string continuation, CancellationToken ct)
        {
            Calls.Add("OnHandoff");
    ...
    class TeamsFeedbackLoopRouteApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnFeedback(TeamsTurnContext ctx, ITurnState state, FeedbackData feedbackData, CancellationToken ct)
        {
    ...
    class TeamsEndOfConversationRouteApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnEndOfConversation(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
    ...
    class TeamsStaticSignInHandlersApp(AgentApplicationOptions options) : AgentApplication(options)
    {
        ...
        public Task OnMessageWithStaticHandlers(TeamsTurnContext ctx, ITurnState state, CancellationToken ct)
        {
