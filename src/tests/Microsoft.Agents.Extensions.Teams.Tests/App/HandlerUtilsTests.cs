...
namespace Microsoft.Agents.Extensions.Teams.Tests.App
{
    public class HandlerUtilsTests
    {
        ...
        {
            var turnContext = CreateTurnContext(new Activity { Type = ActivityTypes.Invoke, Name = "handoff/action", ChannelId = Channels.Msteams });
            ITurnState capturedState = null;
            ITeamsTurnContext capturedContext = null;
        ...
        {
            var turnContext = CreateTurnContext(new Activity { Type = ActivityTypes.Invoke, Name = "message/submitAction", ChannelId = Channels.Msteams });
            ITurnState capturedState = null;
            ITeamsTurnContext capturedContext = null;
