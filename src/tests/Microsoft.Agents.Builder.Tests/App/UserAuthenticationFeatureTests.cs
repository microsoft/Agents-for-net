...
namespace Microsoft.Agents.Builder.Tests.App
{
    public class UserAuthenticationFeatureTests
    {
        ...
        public void Test_DefaultHandlerNameNotFound()
        {
            ...
            { 
                UserAuthorization = new UserAuthorizationOptions(new MemoryStorage(), MockConnections.Object, MockGraph.Object) 
                { 
        ...
        public async Task Test_AutoSignIn_Default()
        {
            ...
            { 
                UserAuthorization = new UserAuthorizationOptions(new MemoryStorage(), MockConnections.Object, MockGraph.Object, MockSharePoint.Object) 
            };
        ...
        public async Task Test_AutoSignIn_Named()
        {
            ...
            {
                UserAuthorization = new UserAuthorizationOptions(storage, MockConnections.Object, MockGraph.Object, MockSharePoint.Object)
            };
            var app = new TestApplication(options);
        ...
        public async Task Test_AutoSignIn_Pending()
        {
            ...
            var options = new TestApplicationOptions(storage)
            {
                UserAuthorization = new UserAuthorizationOptions(storage, MockConnections.Object, MockGraph.Object)
            };
            var app = new TestApplication(options);
            var turnContext = MockTurnContext();
            var turnState = await TurnStateConfig.GetTurnStateWithConversationStateAsync(turnContext);
        ...
        public async Task Test_AutoSignInForCached()
        {
            ...
            var options = new TestApplicationOptions(storage)
            {
                UserAuthorization = new UserAuthorizationOptions(storage, MockConnections.Object, graphMock.Object)
                {
        ...
        public async Task Test_PerRoute_Single_AutoOff()
        {
            ...
            var options = new TestApplicationOptions(storage)
            {
                UserAuthorization = new UserAuthorizationOptions(storage, MockConnections.Object, graphMock.Object, sharePointMock.Object, signedInMock.Object)
                {
                    AutoSignIn = UserAuthorizationOptions.AutoSignInOff
                }
            };
        ...
        public async Task Test_PerRoute_Multi_AutoOff()
        {
            ...
            var options = new TestApplicationOptions(storage)
            {
                UserAuthorization = new UserAuthorizationOptions(storage, MockConnections.Object, graphMock.Object, sharePointMock.Object)
                {
                    AutoSignIn = UserAuthorizationOptions.AutoSignInOff
                }
            };
        ...
        public async Task Test_AutoWithOBO_ConfigExchange()
        {
            ...
            var options = new TestApplicationOptions(storage)
            {
                UserAuthorization = new UserAuthorizationOptions(storage, connections, handler)
                {
                    AutoSignIn = UserAuthorizationOptions.AutoSignInOnForAny
                }
            };
        ...
        public async Task Test_Auto_GetTurnTokenRefresh()
        {
            ...
            var options = new TestApplicationOptions(storage)
            {
                UserAuthorization = new UserAuthorizationOptions(storage, MockConnections.Object, graphMock.Object, graphRefreshMock.Object)
                {
                    AutoSignIn = UserAuthorizationOptions.AutoSignInOnForAny,
