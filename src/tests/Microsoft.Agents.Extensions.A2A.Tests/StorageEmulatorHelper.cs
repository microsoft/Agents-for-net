...
// Or Azurite must be running: https://docs.microsoft.com/azure/storage/common/storage-use-azurite
//
...
namespace Microsoft.Agents.Extensions.A2A.Tests
{
    public static class StorageEmulatorHelper
    {
        ...
        {
            var enabled = Environment.GetEnvironmentVariable("XUNITAZURESTORAGETESTENABLED");
