...
namespace Microsoft.Agents.Core.Models
{
    ...
    /// </summary>
    /// <remarks>
    /// Each concrete card implements <see cref="Microsoft.Agents.Core.Models.Card.ToAttachment()"/> to wrap itself in an attachment using its own
    /// content type. <see cref="Microsoft.Agents.Core.Models.Card.ToMessage()"/> builds on that to produce a ready-to-send message activity.
    /// </remarks>
    public abstract class Card
    {
        ...
        /// <returns>An <see cref="Microsoft.Agents.Core.Models.IActivity"/> representing a message activity with the card attached.</returns>
