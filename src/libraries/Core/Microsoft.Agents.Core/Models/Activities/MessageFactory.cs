...
namespace Microsoft.Agents.Core.Models.Activities
{
    ...
    /// var message = new MessageActivity("Hello World");
    ...
    public static class MessageFactory
    {
        ...
        public static IActivity SuggestedActions(IEnumerable<CardAction> cardActions, string text = null, string ssml = null, string inputHint = null, IList<string> toList = default)
        {
            ...
            return new MessageActivity(text, ssml, inputHint)
            {
                SuggestedActions = new SuggestedActions { Actions = [.. cardActions], To = toList }
            };
        }
        ...
        public static IActivity CreateTrace(IActivity activity, string name, object value = null, string valueType = null, [CallerMemberName] string label = null)
        {
            return new TraceActivity(activity, name, value, valueType, label);
        }
