...
namespace Microsoft.Agents.Client
{
    ...
    {
        /// <summary>
        /// Provides a handler for replies from another Agent when an Activity when <see cref="Microsoft.Agents.Core.Models.Activity.DeliveryMode"/> is <see cref="Microsoft.Agents.Core.Models.DeliveryModes.Normal"/> was used.
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public void AddRoute(AgentApplication agentApplication, RouteSelector routeSelector, RouteHandler routeHandler, bool isInvokeRoute = false, bool isAgenticOnly = false, ushort rank = 32767, string[] autoSignInHandlers = null)
        {
