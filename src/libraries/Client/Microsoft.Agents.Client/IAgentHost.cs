...
namespace Microsoft.Agents.Client
{
    ...
    public interface IAgentHost
    {
        ...
        /// <see cref="Microsoft.Agents.Client.AgentResponses.OnAgentReply(Microsoft.Agents.Client.AgentResponseHandler, System.UInt16)"/> handler must be set on the AgentApplication.
        /// </remarks>
        /// <remarks>
        /// This will not properly handle Invoke or ExpectReplies requests as it doesn't return a value.  Use <see cref="Microsoft.Agents.Client.IAgentHost.GetClient(System.String)"/> and
        ...
        /// <param name="agentConversationId">An Agent conversation identifier. More info: <see cref="Microsoft.Agents.Client.IAgentHost.GetOrCreateConversationAsync(Microsoft.Agents.Builder.ITurnContext, System.String, System.Threading.CancellationToken)"/> or <see cref="Microsoft.Agents.Client.IAgentHost.GetConversation(Microsoft.Agents.Builder.ITurnContext, System.String, System.Threading.CancellationToken)"/></param>
        ...
        /// </remarks>
        /// <param name="turnContext"></param>
        /// <param name="agentConversationId">A conversationId return from <see cref="Microsoft.Agents.Client.IAgentHost.GetConversation(Microsoft.Agents.Builder.ITurnContext, System.String, System.Threading.CancellationToken)"/> or <see cref="Microsoft.Agents.Client.IAgentHost.GetOrCreateConversationAsync(Microsoft.Agents.Builder.ITurnContext, System.String, System.Threading.CancellationToken)"/>.</param>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
