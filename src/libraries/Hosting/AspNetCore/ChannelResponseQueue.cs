...
namespace Microsoft.Agents.Hosting.AspNetCore
{
    ...
    public class ChannelResponseQueue(ILogger logger)
    {
        ...
        /// Prefer <see cref="Microsoft.Agents.Hosting.AspNetCore.ChannelResponseQueue.CompleteHandlerForRequestAsync(System.String)"/> when calling from an async context.
        /// </summary>
        /// <param name="requestId"></param>
