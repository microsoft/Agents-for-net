...
/// The method must match the <see cref="Microsoft.Agents.Extensions.MSTeams.App.TeamsRouteHandler"/> delegate signature.
/// <code>
/// // Match by exact type
...
/// The method must match the <see cref="Microsoft.Agents.Extensions.MSTeams.App.TeamsHandoffHandler"/> delegate signature.
/// <code>
/// [TeamsHandoffRoute]
...
/// <param name="autoSignInHandlers">A comma/space/semicolon-delimited list of OAuth sign-in handler names, or the name of an instance or static method on the agent class matching <c>Func&lt;ITurnContext, string[]&gt;</c>.</param>
[AttributeUsage(AttributeTargets.Method, Inherited = true)]
[RouteHandlerType(typeof(TeamsHandoffHandler))]
...
/// The method must match the <see cref="Microsoft.Agents.Extensions.MSTeams.App.TeamsFeedbackLoopHandler"/> delegate signature.
/// <code>
...
/// <param name="autoSignInHandlers">A comma/space/semicolon-delimited list of OAuth sign-in handler names, or the name of an instance or static method on the agent class matching <c>Func&lt;ITurnContext, string[]&gt;</c>.</param>
[AttributeUsage(AttributeTargets.Method, Inherited = true)]
[RouteHandlerType(typeof(TeamsFeedbackLoopHandler))]
