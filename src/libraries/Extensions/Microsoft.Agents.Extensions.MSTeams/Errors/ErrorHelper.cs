...
namespace Microsoft.Agents.Extensions.MSTeams.Errors
{
    /// <summary>
    /// Error helper for Teams Agent Extension
    /// This is used to setup the localized error codes for the Teams Agent Extension
    /// 
