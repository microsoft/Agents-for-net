...
namespace Microsoft.Agents.Extensions.MSTeams.Compat;
...
///     [new Microsoft.Agents.Extensions.MSTeams.Compat.SetTeamsApiClientMiddleware(sp.GetService&lt;IConnections>(), sp.GetService&lt;IHttpClientFactory>())]);
/// </code>
/// </remarks>
public class SetTeamsApiClientMiddleware : IMiddleware
{
    ...
    {
        if (turnContext.Activity.ChannelId == Microsoft.Agents.Core.Models.Channels.Msteams)
        {
