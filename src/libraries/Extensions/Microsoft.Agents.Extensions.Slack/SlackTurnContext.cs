...
/// <summary>
/// A Slack-aware <see cref="Microsoft.Agents.Builder.ITurnContext"/> that exposes Slack-specific helpers such as the Slack API client
/// and strongly-typed channel data on top of the underlying turn context.
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="Microsoft.Agents.Extensions.Slack.SlackTurnContext"/> class wrapping the specified inner turn context.
/// </remarks>
