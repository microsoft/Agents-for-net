...
public delegate Task FileConsentHandler(TeamsTurnContext turnContext, ITurnState turnState, Microsoft.Teams.Api.FileConsentCardResponse fileConsentCardResponse, CancellationToken cancellationToken);
