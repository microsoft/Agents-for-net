...
public delegate Task TeamUpdateHandler(TeamsTurnContext turnContext, ITurnState turnState, Microsoft.Teams.Api.Team data, CancellationToken cancellationToken);