...
public delegate Task ChannelUpdateHandler(TeamsTurnContext turnContext, ITurnState turnState, Microsoft.Teams.Api.Channel data, CancellationToken cancellationToken);
