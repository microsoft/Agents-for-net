...
namespace Microsoft.Agents.Extensions.Teams.Compat
{
    ...
    public class TeamsActivityHandler : ActivityHandler
    {
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>The Messaging Extension Response for the query.</returns>
        protected virtual Task<MessagingExtensionResponse> OnTeamsMessagingExtensionSelectItemAsync(ITurnContext<IInvokeActivity> turnContext, JsonElement query, CancellationToken cancellationToken)
        {
            throw new InvokeResponseException(HttpStatusCode.NotImplemented);
        }
        ...
        protected virtual Task<ConfigResponseBase> OnTeamsConfigFetchAsync(ITurnContext<IInvokeActivity> turnContext, JsonElement configData, CancellationToken cancellationToken)
        {
            throw new InvokeResponseException(HttpStatusCode.NotImplemented);
        }
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>A Config Response for the request.</returns>
        protected virtual Task<ConfigResponseBase> OnTeamsConfigSubmitAsync(ITurnContext<IInvokeActivity> turnContext, JsonElement configData, CancellationToken cancellationToken)
        {
            throw new InvokeResponseException(HttpStatusCode.NotImplemented);
        }
        ...
        protected virtual Task OnTeamsMembersRemovedDispatchAsync(IList<ChannelAccount> membersRemoved, TeamInfo teamInfo, ITurnContext<IConversationUpdateActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            {
                teamsMembersRemoved.Add(ProtocolJsonSerializer.ToObject<TeamsChannelAccount>(memberRemoved));
            }
            ...
            if (turnContext.Activity.ChannelId == Channels.Msteams)
            {
                switch (turnContext.Activity.Name)
                {
                    ...
                    case "application/vnd.microsoft.meetingStart":
                        return OnTeamsMeetingStartAsync(ProtocolJsonSerializer.ToObject<MeetingStartEventDetails>(turnContext.Activity.Value), turnContext, cancellationToken);
                    case "application/vnd.microsoft.meetingEnd":
                        return OnTeamsMeetingEndAsync(ProtocolJsonSerializer.ToObject<MeetingEndEventDetails>(turnContext.Activity.Value), turnContext, cancellationToken);
                    case "application/vnd.microsoft.meetingParticipantJoin":
                        return OnTeamsMeetingParticipantsJoinAsync(ProtocolJsonSerializer.ToObject<MeetingParticipantsEventDetails>(turnContext.Activity.Value), turnContext, cancellationToken);
                    case "application/vnd.microsoft.meetingParticipantLeave":
                        return OnTeamsMeetingParticipantsLeaveAsync(ProtocolJsonSerializer.ToObject<MeetingParticipantsEventDetails>(turnContext.Activity.Value), turnContext, cancellationToken);
                }
            }
