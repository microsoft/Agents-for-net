...
namespace Microsoft.Agents.Extensions.Teams.App
{
    ...
    /// public async Task OnEventAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnEventOrInvokeAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// [TeamsActivityRoute]
    /// public async Task OnAnyAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnInstallationUpdateAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// // Match any message
    /// [TeamsMessageRoute]
    /// public async Task OnMessageAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ///     // Handle any message
    /// }
    ///
    ...
    /// public async Task OnHelloAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnHelloPatternAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// // Match any event
    /// [TeamsEventRoute]
    /// public async Task OnAnyEventAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ///     // Handle any event activity
    /// }
    ///
    ...
    /// public async Task OnMyEventAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnMyEventPatternAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnConversationUpdateAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnMembersAddedAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnMembersRemovedAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
    ...
    /// <code>
    /// [TeamsHandoffRoute]
    /// public async Task OnHandoffAsync(TeamsTurnContext turnContext, ITurnState turnState, string continuation, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnFeedbackAsync(TeamsTurnContext turnContext, ITurnState turnState, FeedbackData feedbackData, CancellationToken cancellationToken)
    /// {
    ...
    /// public async Task OnEndOfConversationAsync(TeamsTurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    /// {
