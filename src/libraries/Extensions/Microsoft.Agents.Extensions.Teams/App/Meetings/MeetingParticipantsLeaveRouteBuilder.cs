...
/// </summary>
/// <remarks>
/// Use <see cref="MeetingParticipantsLeaveRouteBuilder"/> to create and configure routes that respond to
/// <c>application/vnd.microsoft.meetingParticipantLeave</c> event activities.
/// <code>
