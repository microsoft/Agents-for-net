...
namespace Microsoft.Agents.Extensions.Teams
{
    ...
    public delegate Task TeamsFeedbackLoopHandler(TeamsTurnContext turnContext, ITurnState turnState, FeedbackData feedbackData, CancellationToken cancellationToken);
}