...
using static Microsoft.Agents.Extensions.Teams.AI.Prompts.CompletionConfiguration;
...
namespace Microsoft.Agents.Extensions.Teams.AI.Models
{
    ...
    public class OpenAIModel : IPromptCompletionStreamingModel
    {
        ...
        /// <inheritdoc/>
        public async Task<PromptResponse> CompletePromptAsync(ITurnContext turnContext, ITurnState memory, IPromptFunctions<List<string>> promptFunctions, ITokenizer tokenizer, PromptTemplate promptTemplate, CancellationToken cancellationToken = default)
        {
...
#pragma warning restore CA2017 // Parameter count mismatch
            ...
            if (this._options.Stream == true)
            {
                IStreamingResponse? streamer = memory.GetValue<IStreamingResponse>("temp.streamer");
