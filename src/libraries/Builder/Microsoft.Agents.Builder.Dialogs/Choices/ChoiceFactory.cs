...
namespace Microsoft.Agents.Builder.Dialogs.Choices
{
    ...
    public class ChoiceFactory
    {
        ...
        public static IActivity ForChannel(string channelId, IList<Choice> list, string text = null, string speak = null, ChoiceFactoryOptions options = null)
        {
        ...
        public static IActivity ForChannel(ChannelId channelId, IList<Choice> list, string text = null, string speak = null, ChoiceFactoryOptions options = null, string conversationType = default, IList<string> toList = default)
        {
            ...
            var supportsSuggestedActions = Channels.SupportsSuggestedActions(channelId, list.Count, conversationType);
            var supportsCardActions = Channels.SupportsCardActions(channelId, list.Count);
            var maxActionTitleLength = Channels.MaxActionTitleLength(channelId);
            var hasMessageFeed = Channels.HasMessageFeed(channelId);
