...
namespace Microsoft.Agents.Builder.Dialogs.Prompts
{
    ...
    public class ActivityPrompt : Dialog
    {
        ...
        public override async Task<DialogTurnResult> ContinueDialogAsync(DialogContext dc, CancellationToken cancellationToken = default)
        {
            ...
            if (_validator != null)
            {
                var promptContext = new PromptValidatorContext<IActivity>(dc.Context, recognized, state, options);
            ...
            // CastTo can create a new object that was passed around.  Update the instance state.
        ...
        public override async Task RepromptDialogAsync(ITurnContext turnContext, DialogInstance instance, CancellationToken cancellationToken = default)
        {
            ...
            {
                // Update the state since CastTo can create a new object (that may have been changed).
                instance.State[PersistedState] = state;
                instance.State[PersistedOptions] = options;
            }
        }
        ...
        {
            return Task.FromResult(new PromptRecognizerResult<IActivity>
            {
                Succeeded = true,
