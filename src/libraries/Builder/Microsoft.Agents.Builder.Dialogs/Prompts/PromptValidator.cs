...
namespace Microsoft.Agents.Builder.Dialogs.Prompts
{
    ...
    /// </summary>
    /// <typeparam name="T">The type the associated <see cref="Microsoft.Agents.Builder.Dialogs.Prompts.Prompt{T}"/> prompts for.</typeparam>
    /// <param name="promptContext">The prompt validation context.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A <see cref="System.Threading.Tasks.Task"/> of bool representing the asynchronous operation indicating validation success or failure.</returns>
