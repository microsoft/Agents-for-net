...
namespace Microsoft.Agents.Builder.Dialogs.Prompts
{
    ...
    public class ChoicePrompt : Prompt<FoundChoice>
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                prompt = AppendChoices(options.RetryPrompt, channelId, choices, choiceStyle, choiceOptions, conversationType, toList, cancellationToken);
            }
            else
            {
                prompt = AppendChoices(options.Prompt, channelId, choices, choiceStyle, choiceOptions, conversationType, toList, cancellationToken);
            }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                var activity = (IMessageActivity)turnContext.Activity;
        ...
        private string DetermineCulture(IActivity activity, FindChoicesOptions opt = null)
        {
