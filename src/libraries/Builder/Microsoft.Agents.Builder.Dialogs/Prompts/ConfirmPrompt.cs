...
namespace Microsoft.Agents.Builder.Dialogs.Prompts
{
    ...
    public class ConfirmPrompt : Prompt<bool>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Microsoft.Agents.Builder.Dialogs.Prompts.ConfirmPrompt"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the yes and no <see cref="Microsoft.Agents.Builder.Dialogs.Choices.Choice"/> for the prompt.
        /// </summary>
        /// <value>The yes and no <see cref="Microsoft.Agents.Builder.Dialogs.Choices.Choice"/> for the prompt.</value>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                prompt = AppendChoices(options.RetryPrompt, channelId, choices, style, choiceOptions, conversationType, toList, cancellationToken);
            }
            else
            {
                prompt = AppendChoices(options.Prompt, channelId, choices, style, choiceOptions, conversationType, toList, cancellationToken);
            }
        ...
        private string DetermineCulture(IActivity activity)
        {
