...
namespace Microsoft.Agents.Builder.Testing
{
    ...
    /// </summary>
    /// <seealso cref="Microsoft.Agents.Builder.Testing.TestFlow"/>
    public class TestAdapter : ChannelAdapter
    {
        private bool _sendTraceActivity;
        private readonly object _conversationLock = new();
        private readonly object _activeQueueLock = new();
        private readonly IUserTokenClient _userTokenClient = new MockUserTokenClient();

        private int _nextId = 0;
        private Queue<TaskCompletionSource<IActivity>> _queuedRequests = new Queue<TaskCompletionSource<IActivity>>();

        /// <summary>
        /// Initializes a new instance of the <see cref="Microsoft.Agents.Builder.Testing.TestAdapter"/> class.
        /// </summary>
        /// <param name="channelId">The target <see cref="Microsoft.Agents.Core.Models.Channels"/> for the test the will be passed to the bot.</param>
        /// <param name="sendTraceActivity">Indicates whether the adapter should add to its <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ActiveQueue"/>
        /// <param name="logger">Logger for this class</param>
        /// any trace activities generated by the bot.</param>
        /// <param name="tokenClient"></param>
        public TestAdapter(string channelId, bool sendTraceActivity = false, ILogger logger = null, IUserTokenClient tokenClient = null) : base (logger)
        {
            _sendTraceActivity = sendTraceActivity;
            _userTokenClient = tokenClient ?? new MockUserTokenClient();
        ...
        /// any trace activities generated by the bot.</param>
        /// <param name="tokenClient"></param>
        public TestAdapter(ConversationReference conversation = null, bool sendTraceActivity = false, ILogger logger = null, IUserTokenClient tokenClient = null) : base(logger)
        {
            _sendTraceActivity = sendTraceActivity;
            _userTokenClient = tokenClient ?? new MockUserTokenClient();
        ...
        /// <summary>
        /// Creates a new <see cref="Microsoft.Agents.Builder.Testing.TestAdapter"/> with a pre-configured <see cref="Microsoft.Agents.Core.Models.ConversationReference"/>.
        /// All parameters use the same defaults as <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.TestAdapter(Microsoft.Agents.Core.Models.ConversationReference, System.Boolean, Microsoft.Extensions.Logging.ILogger, Microsoft.Agents.Connector.IUserTokenClient)"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="claimsIdentity">A <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ClaimsIdentity"/> for the conversation.</param>
        /// <param name="continuationActivity">The continuation <see cref="Microsoft.Agents.Core.Models.Activity"/> used to create the <see cref="Microsoft.Agents.Builder.ITurnContext" />.</param>
        ...
        /// <summary>
        /// Replaces an existing activity in the <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ActiveQueue"/>.
        /// </summary>
        /// <param name="turnContext">Context for the current turn of conversation.</param>
        ...
        /// <summary>
        /// Deletes an existing activity in the <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ActiveQueue"/>.
        /// </summary>
        /// <param name="turnContext">Context for the current turn of conversation.</param>
        ...
        /// or threads to receive notice of cancellation.</param>
        /// <returns>A task that represents the work queued to execute.</returns>
        /// <remarks>This resets the <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ActiveQueue"/>, and does not maintain multiple conversation queues.</remarks>
        ...
        /// <summary>
        /// Returns a thread-safe snapshot of the current contents of the <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ActiveQueue"/>.
        /// </summary>
        /// <returns>An array copy of the activities currently queued.</returns>
        /// <remarks>
        /// Enqueues happen under an internal lock, but the <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ActiveQueue"/> property itself
        ...
        /// <summary>
        /// Dequeues and returns the next bot response from the <see cref="Microsoft.Agents.Builder.Testing.TestAdapter.ActiveQueue"/>.
        /// </summary>
        /// <returns>The next activity in the queue; or null, if the queue is empty.</returns>
        /// <remarks>A <see cref="Microsoft.Agents.Builder.Testing.TestFlow"/> object calls this to get the next response from the bot.</remarks>
        ...
        /// <remarks>A <see cref="Microsoft.Agents.Builder.Testing.TestFlow"/> object calls this to get a message activity
        ...
        /// <returns>A task that represents the work queued to execute.</returns>
        /// <seealso cref="Microsoft.Agents.Builder.Testing.TestFlow.Send(System.String)"/>
        ...
        {
            if (_userTokenClient is MockUserTokenClient mockUserTokenClient)
            {
                mockUserTokenClient.AddUserToken(connectionName, channelId, userId, token, magicCode);
            }
        }
        ...
        public void AddExchangeableToken(string connectionName, string channelId, string userId, string exchangableItem, string token)
        {
            if (_userTokenClient is MockUserTokenClient mockUserTokenClient)
            {
                mockUserTokenClient.AddExchangeableToken(connectionName, channelId, userId, exchangableItem, token);
            }
        }
        ...
        public void ThrowOnExchangeRequest(string connectionName, string channelId, string userId, string exchangableItem)
        {
            if (_userTokenClient is MockUserTokenClient mockUserTokenClient)
            {
                mockUserTokenClient.ThrowOnExchangeRequest(connectionName, channelId, userId, exchangableItem);
            }
        }
        ...
        /// </summary>
        /// <param name="activity">An <see cref="Microsoft.Agents.Core.Models.Activity"/> instance for the turn.</param>
        /// <param name="identity"></param>
        /// <returns>A <see cref="Microsoft.Agents.Builder.TurnContext"/> instance to be used by the adapter.</returns>
