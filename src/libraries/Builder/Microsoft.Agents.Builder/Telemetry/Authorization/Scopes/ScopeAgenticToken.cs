...
{
    /// <summary>
    /// A <see cref="Microsoft.Agents.Builder.Telemetry.Authorization.Scopes.ScopeAuthorizationRequest"/> that traces the acquisition of an agentic
    /// token during the authorization pipeline.
    /// </summary>
    internal class ScopeAgenticToken : ScopeAuthorizationRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Microsoft.Agents.Builder.Telemetry.Authorization.Scopes.ScopeAgenticToken"/> class.
        /// </summary>
