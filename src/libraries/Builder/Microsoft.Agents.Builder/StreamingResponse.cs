...
namespace Microsoft.Agents.Builder
{
    ...
    internal class StreamingResponse : StreamingResponseBase
    {
        ...
        public override bool FeedbackLoopEnabled { get; set; } = false;

        /// <summary>
        /// Gets or sets the type of feedback loop used in the system.
        /// </summary>
        /// <remarks>The default value is "default". Teams also supports "custom".</remarks>
        public override string FeedbackLoopType { get; set; } = "default";
        ...
        /// </summary>
        public override void AddCitation(Citation citation, int citationPosition)
        {
            Citations ??= [];
        ...
        /// </summary>
        public override void AddCitations(IList<Citation> citations)
        {
        ...
        /// </summary>
        public override void AddCitation(ClientCitation citation)
        {
            Citations ??= [];
        ...
        /// </summary>
        public override void AddCitations(IList<ClientCitation> citations)
        {
            if (citations.Count > 0)
            {
                Citations ??= [];
