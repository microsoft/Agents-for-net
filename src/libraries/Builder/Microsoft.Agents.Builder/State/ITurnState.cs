...
namespace Microsoft.Agents.Builder.State
{
    ...
    public interface ITurnState
    {
        ...
        /// </summary>
        /// <param name="path">The full path to the property: `{scope}.{name}`.  If `{scope}` is missing the value is a get on <see cref="Microsoft.Agents.Builder.State.ITurnState.Temp"/>.</param>
        ...
        /// <remarks>
        /// `{scope}` is always the name of an <see cref="Microsoft.Agents.Builder.State.IAgentState.Name"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="path">The full path to the property: `{scope}.{name}`.  If `{scope}` is missing the value is a set on <see cref="Microsoft.Agents.Builder.State.ITurnState.Temp"/>.</param>
        ...
        /// Delete a property.
        /// </summary>
        /// <param name="path">The full path to the property: `{scope}.{name}`. If `{scope}` is missing the value is deleted on <see cref="Microsoft.Agents.Builder.State.ITurnState.Temp"/>.</param>
        /// <remarks>
        /// `{scope}` is always the name of an <see cref="Microsoft.Agents.Builder.State.IAgentState.Name"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="path">The full path to the property: `{scope}.{name}`. If `{scope}` is missing the value is against <see cref="Microsoft.Agents.Builder.State.ITurnState.Temp"/>.</param>
        /// <remarks>
        /// `{scope}` is always the name of an <see cref="Microsoft.Agents.Builder.State.IAgentState.Name"/>.
        /// </remarks>
        ...
        /// <see cref="Microsoft.Agents.Builder.State.ITurnState.SaveStateAsync(Microsoft.Agents.Builder.ITurnContext, System.Boolean, System.Threading.CancellationToken)"/> to persist this
