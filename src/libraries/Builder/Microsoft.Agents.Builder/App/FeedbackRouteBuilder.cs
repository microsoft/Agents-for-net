...
namespace Microsoft.Agents.Builder.App
{
    ...
    /// </summary>
    /// <remarks>
    /// Use <see cref="FeedbackRouteBuilder"/> to create and configure routes that respond to activities of type 'invoke' with 
    ...
    /// and further configured using <see cref="WithHandler(FeedbackLoopHandler)"/>.<br/><br/>
    /// Example usage:<br/><br/>
    /// <code>
    ...
    public class FeedbackRouteBuilder : RouteBuilderBase<FeedbackRouteBuilder>
    {
        ...
        /// <returns>The current <see cref="FeedbackRouteBuilder"/> instance for method chaining.</returns>
