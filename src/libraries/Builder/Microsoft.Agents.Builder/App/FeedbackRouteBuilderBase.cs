...
{
    /// <summary>
    /// Provides the generic base builder for routing feedback loop invoke activities in an <see cref="Microsoft.Agents.Builder.App.AgentApplication"/>.
    /// </summary>
    /// <remarks>
    /// Derive from <see cref="Microsoft.Agents.Builder.App.FeedbackRouteBuilderBase{TBuilder}"/> to create specialized feedback route builders
