...
namespace Microsoft.Agents.Builder.App
{
    ...
    public class EventRouteBuilder : RouteBuilderBase<EventRouteBuilder>
    {
        ...
        {
            AssertionHelpers.ThrowIfNull(handler, nameof(handler));
            _route.Handler = (ct, ts, ctok) => handler(new TypedTurnContext<IEventActivity>(ct), ts, ctok);
            return this;
        }
            ...
            if (_route.Selector != null)
            {
                if (_eventName != null || _eventRegex != null)
                {
                    ...
                    _route.Selector = async (context, ct) =>
                        ...
                        && (_eventName != null ? _eventName.Equals(eventActivity.Name, StringComparison.OrdinalIgnoreCase) : eventActivity.Name != null && _eventRegex.IsMatch(eventActivity.Name))
