...
namespace Microsoft.Agents.Builder.App.UserAuth
{
    ...
    public class UserAuthorizationOptions
    {
        ...
        public readonly static AutoSignInSelector AutoSignInOnForMessages = (context, cancellationToken) => Task.FromResult(context.Activity.IsType(ActivityType.Message));
