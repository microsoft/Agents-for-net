...
namespace Microsoft.Agents.Builder.App
{
    ...
    public class InvokeRouteBuilder : RouteBuilderBase<InvokeRouteBuilder>
    {
        ...
        public InvokeRouteBuilder WithHandler(RouteHandler<IInvokeActivity> handler)
        {
            AssertionHelpers.ThrowIfNull(handler, nameof(handler));
            _route.Handler = (ct, ts, ctok) => handler(new TypedTurnContext<IInvokeActivity>(ct), ts, ctok);
            return this;
        }
            ...
            if (_route.Selector != null)
            {
                if (_invokeName != null || _invokeRegex != null)
                {
                    ...
                    _route.Selector = async (context, ct) =>
                        ...
                        && (_invokeName != null ? _invokeName.Equals(invokeActivity.Name, StringComparison.OrdinalIgnoreCase) : invokeActivity.Name != null && _invokeRegex.IsMatch(invokeActivity.Name))
